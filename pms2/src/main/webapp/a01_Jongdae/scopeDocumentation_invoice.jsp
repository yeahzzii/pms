  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="../Dashio/invoice.html">Invoice</a></li>
            ...
            <div class="col-lg-10 col-lg-offset-1">
              <div class="invoice-body">
                ...
                <div class="row">
                  ...
                  부서 위치<br>
                  대한민국<br>
                  <abbr>P:</abbr> (123) 456-7890 팀장 연락처
                </address>
                  </div>
                  <!-- /col-md-9 -->
                  <div class="col-md-3">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-right">$1729.00</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="text-right"><strong>$1729.00</strong></td>
                    </tr>
                  </tbody>
                </table>
                <br>
              ...
              <div class="form-group" align="center">
                <button class="btn btn-success" type="button" style="width:100px;">승인</button>
                <button class="btn btn-danger" type="button" style="width:100px;">반려</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="../Dashio/invoice.html#" class="go-top">
