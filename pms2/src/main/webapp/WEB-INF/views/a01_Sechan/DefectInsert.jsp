  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>기습결함등록</h3><br>
        <div class="row">
        	<div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="get">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">기습결함명</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="기습결함명 입력">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">결함위치</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="결함위치 입력">
                  </div>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">결함상세내용</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="결함상세내용 입력">
                  </div>
                </div>          
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">pm명</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="pm명 입력">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">특이사항</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="특이사항 입력">
                  </div>
                </div>
