			...
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu"><a class="active" href="javascript:;">
						...
						<ul class="sub">
							<li class="active"><a href="basic_table.html">Basic
									Table</a></li>
        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right text-center"></i> 위험관리
				    <i class="fa fa-angle-right"></i> 위험관리 상세페이지
				</h3>
				<div class="col-md-12">
				<div class="text-right">
                    <input type="button" value="리스트로" class="btn btn-primary">				
				</div>
				</div>
				<div class="row">
					 <div class="col-md-12">
              <div class="form-panel">
                <div class="form-horizontal style-form">
                  <div class="form-group mt">
                    <h5 class="col-md-2 text-center">
                      <strong> 위험목록 ID </strong>
                    </h5>
                    <h4 class="col-md-10">HUH_WWW</h4>
                  </div>
                  <div class="form-group">
                    <h5 class="col-md-2 text-center">
                      <strong> 위험도 </strong>
                    </h5>
                    <h4 class="col-md-10">상</h4>
                  </div>
                  <div class="form-group">
                    <h5 class="col-md-2 text-center">
                      <strong> 영향도 </strong>
                    </h5>
                    <h4 class="col-md-10">3</h4>
                  </div>
                  <div class="form-group">
                    <h5 class="col-md-2 text-center">
                      <strong> 등록일 </strong>
                    </h5>
                    <h4 class="col-md-10">2022-07-24</h4>
                  </div>
                  <div class="form-group">
                    <h5 class="col-md-2 text-center">
                      <strong> 등록자 </strong>
                    </h5>
                    <h4 class="col-md-10">관리자 이헌용</h4>
                  </div>
                  <div class="form-group">
                    <h5 class="col-md-2 text-center">
                      <strong> 위험목록 </strong>
                    </h5>
                    <h4 class="col-md-10">TEXT</h4>
                  </div>
                  <div class="form-group">
                    <h5 class="col-md-2 text-center">
                      <strong> 위험조치계획 </strong>
                    </h5>
                    <h4 class="col-md-10">TEXT</h4>
                  </div>
                  <div class="form-group">
               ...
               <div class="col-md-12 text-right">
                ...
                <input type="button" value="삭제" class="btn btn-theme04 delete"/>
            </div>
            </div>
				</div>
				<!-- row -->
	...
	<script type="text/javascript">
		$(function() {
			$("tr[data-id]").on("click", function() {
				...
				location.href = `01.riskManagementDetail.jsp?id=` + id;
			});
		});
	</script>
</body>
