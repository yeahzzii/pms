						...
						<div class="row content-panel">
							<div class="col-md-4 profile-text mt mb centered">
								<div class="right-divider hidden-sm hidden-xs">
									<img id="aeap_img" alt="file_img" src="introduce.png">
								</div>
							</div>
							<!-- /col-md-4 -->
							<div class="col-md-4 profile-text">
								...
								<p>
									국내외 많은 기업체 및 연구소는 효율적 프로젝트 관리를 위하여 프로젝트 관리 시스템을 도입합니다.<br>
									조직의 프로세스 및 자원에 대한 체계적 관리 및 협업 기능을 통한 업무 표준을 확립하고, <br>
									현황관리를 통한 빠른 의사결정이 이루어질 수 있도록 하기 위한 시스템의 필요성을 보여줍니다 <br> <br>
									<strong>As Effective As Possible.</strong><br> 이 문구가 내포하는
									의미처럼 프로젝트 업무의 효율성과<br> 조직관리를 위한 최적화된 프로젝트 관리 시스템을 소개하고자
									합니다.
								</p>
								<br>
							</div>
							...
							<div class="col-md-4 centered">
								<div class="dropdown">
									<button class="dropbtn">
										...
										<img class="country" src="kr.png" /></span>
									</button>
									<div class="dropdown-content" id="selLan">
										<a href="#"><img class="country" src="./us.png"/> </a> 
										<a href="#"><img class="country" src="./cn.png"/> </a>
										<a href="#"><img class="country" src="./jp.png"/> </a>
									</div>
								</div>
							</div>
							<!-- /col-md-4 -->
