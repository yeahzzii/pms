  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> 검토계획 등록</h3><br>
        <div class="row">
        	<div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Form Elements</h4>
              <form id="frm01" action="${path}/rplanInsert.do" class="form"  method="post">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">검토계획명</label>
                  <div class="col-sm-10">
                    <input name="rplanname" type="text" class="form-control" placeholder="검토계획명 입력">
                  </div><br>
                </div><br>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   ...
                   <div class="input-group input-large" data-date="01/01/2014" data-date-format="mm/dd/yyyy">
                      ...
                      <input type="text" class="form-control dpd1" name="requestdate">
                      <span class="input-group-addon">To</span>
                      <input type="text" class="form-control dpd2" name="approvaldate">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="rplanstep" type="text" class="form-control" placeholder="단계입력">
                 <br> </div>
                </div>          
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="prjname" type="text" class="form-control" placeholder="프로젝트명 입력">
                  <br></div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="pmname" type="text" class="form-control" placeholder="PM명 입력">
                  <br></div>
                </div><br>
                
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">승인상태</label>
                  <div class="col-sm-10">
                    <input name="rplanstatus" type="text" class="form-control" placeholder="승인상태 입력">
                  <br></div>
                </div><br>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="specialnote" type="text" class="form-control" placeholder="특이사항 입력">
                  <br></div>
                </div><br>
                ...
                <div class="find-btn">
          			...
          			<button type="submit" class="btn btn-success find-btn1">등록  </button>
