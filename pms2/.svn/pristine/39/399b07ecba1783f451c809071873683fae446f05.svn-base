                ...
                <div class="compose-mail">
                  <form id="sendmail" role="form-horizontal" action="${path}/mailSender.do" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" name="receiver" value="${mail.receiver}" tabindex="1" id="to" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="mailTitle" value="${mail.mailTitle}" tabindex="1" id="subject" class="form-control">
                    </div>
                    <div class="compose-editor">
                      <textarea class="wysihtml5 form-control" name="mailContent" rows="9"></textarea>
                      <input type="file" class="default" name="mailReport" value="${mail.mrFileName}">
                    </div>
