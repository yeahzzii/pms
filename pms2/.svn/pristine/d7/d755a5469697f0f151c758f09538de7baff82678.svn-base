   ...
   if(sessionVal == ""){
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><img src="${path}/a00_Common/a01_css/schedule.png" alt="" style="width:50px; height:50px"> 프로젝트No ${param.prjNo} 일정</h3>
        <!-- COMPLEX TO DO LIST -->
        <div class="row mt">
          <div class="col-md-12">
                    ...
                    <li>
                      ...
                      <div class="task-title">
                        ...
                        <div class="pull-right hidden-phone">
                          ...
                          <button class="btn btn-primary btn-xs"><i class="fa fa-pencil" onclick="goCalendar('${callist.prjNo}')"></i></button>
