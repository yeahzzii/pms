...
<body onload="counter_init()">
  <section id="container">
              ...
              <h3> ${project.prjno}프로젝트 대시보드</h3>
				...
				<div id="main-button" class="d-flex justify-content-between mb-4">
						...
						<div onclick="location.href=''" class="p-5 m-3" id="TOFont"
							...
							<i class="fa fa-check-square-o" id="button-icon"></i>&nbsp;&nbsp;&nbsp; New post</div>
					</div>
	...
	<canvas id="RplanStep" height="220"></canvas>
	<script>
    var rplanCnt = []
	var rplanStep = []
                ...
                <div class="white-panel pn" style="height: 420px;">
                  <div class="white-header">
                    <h5>프로젝트 품질점수</h5>
                        	...
                        	<canvas id="Score4" height="300"></canvas>
	<script>
    var scores = []
    var prjno = "${param.prjno}"
	$.ajax({
                ...
                <!--  /darkblue panel -->
							...
							<div class="col-lg-8 col-sm-5 mb" style="height: 460px;"> 
								<div class="white-panel pn" style="height: 420px;">
									...
									<canvas id="PrjNRate" height="100"></canvas>
	<script>
    var prjRate2 = []
    var prjno4 = []
    var prjno = "${param.prjno}"
					...
					<div class="col-lg-12 main-chart" style="margin-top:-35px; margin-bottom:60px;">
						<div class="row mt">
							...
							<div class="col-lg-6" style="height: 460px;">
								...
								<!-- 직책별 사원수 -->
	<canvas id="JobCnt" height="200"></canvas>
	<script>
    var jobcnt = []
	var job = []
    var prjno = "${param.prjno}"
	...
	<canvas id="HRSal" height="200"></canvas>
	<script>
    var sals = []
	var ename = []
    var prjno = "${param.prjno}"
