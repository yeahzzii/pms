            ...
            <section class="panel">
              ...
              <div class="panel-body ">
                <div class="mail-header row">
                  <div class="col-md-8">
                    <h4 class="pull-left"> 0802 회의록 </h4>
                  </div>
                  
             <div class="col-md-4">
                      <p class="date"> {meetingboard.recordViewCnt}</p>
                    </div>
                </div>
                ...
                <div class="attachment-mail">
                  <p>
                    <span><i class="fa fa-paperclip"></i> 2 개의 첨부파일 — </span>
                    <a href="#">첨부파일 모두 다운로드</a> |
                    <a href="#">이미지 보기</a>
                  </p>
                  <ul>
                    <li>
                ...
                <div class="compose-btn">
                  <button class="btn btn-theme btn-sm"><i class="fa fa-check"></i> 등록</button>
