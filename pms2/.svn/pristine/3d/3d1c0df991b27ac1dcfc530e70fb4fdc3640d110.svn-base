        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 프로젝트 리스트 <i
						class="fa fa-angle-right"></i> 프로젝트 등록
				</h3>
							...
							<div class=" form">
								<form class="cmxform form-horizontal style-form"
									...
									<div class="form-group col-lg-6">
										<label for="prjName" class="control-label col-lg-4">프로젝트명</label>
										<div class="col-lg-8">
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">목적</label>
										<div class="col-lg-8">
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">결과물</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
										</div>
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">범위
											외</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">프로젝트
											시작일</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">예산</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
										</div>
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">PM번호</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
										</div>
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">중요도</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
										</div>
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">설비
											비용</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">자재
											비용</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">서비스
											비용</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">간접
											비용</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">예비비</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
										</div>
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">일정관리
											품질점수</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">인적자원
											품질점수</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">비용관리
											품질점수</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
									...
									<div class="form-group col-lg-6">
										<label for="cemail" class="control-label col-lg-4">의사소통관리
											품질점수</label>
										<div class="col-lg-8">
											<input class="form-control " id="cemail" type="text"
												name="email" required />
