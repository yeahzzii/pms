                ...
                <div class="mail-option">
                 <div class="chk-all">
                    <div class="pull-left mail-checkbox">
                     전체 선택  <input type="checkbox" class="" id="allCheck" name="allCheck">
                    </div>
                  </div>
                  <div class="btn-group">
                    ...
                    <c:forEach var="mail" items="${mlist}">
                      <tr class="unread" ondblclick="goDetail(${mail.mailNum})">
                        <td class="inbox-small-cells">
                          <input type="checkbox" class="mail-checkbox" name="RowCheck" value="${mail.mailNum}">
                        </td>
                        <td class="inbox-small-cells"><i class="fa fa-star"></i></td> 
                        <td class="view-message  dont-show">${mail.receiver}</td>
                        <td class="view-message ">${mail.mailTitle}</td>
                        <td class="view-message  inbox-small-cells"><input type="hidden" value="${mail.mailNum}"></td>
...
$(function(){
	...
	$("input[name='allCheck']").click(function(){
		...
		for (var i=0; i<chk_listArr.length; i++){
			chk_listArr[i].checkd = this.checked;
		}
	});
