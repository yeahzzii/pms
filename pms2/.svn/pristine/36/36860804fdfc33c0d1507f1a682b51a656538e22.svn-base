        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form id="frm01" action="${path}/fbplanInsert.do" class="form"  method="post">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">시정조치명</label>
                  <div class="col-sm-10">
                    <input type="text" name="feedbackname" class="form-control" placeholder="시정조치명 입력">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">프로젝트명</label>
                  <div class="col-sm-10">
                    <input type="text" name="fbplanname" class="form-control" placeholder="프로젝트명 입력">
                  </div>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">단계</label>
                  <div class="col-sm-10">
                    <input type="text" name="fbstep" class="form-control" placeholder="단계입력">
                  </div>
                </div>          
                 <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">검토계획기간</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="feedbackitem" class="form-control" placeholder="시정조치사항 입력">
                  </div>
                </div>
                
                 <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">승인여부</label>
                  <div class="col-sm-10">
                    <input type="text" name="fbstatus" class="form-control" placeholder="시정조치사항 입력">
                  </div>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">PM명</label>
                  <div class="col-sm-10">
                    <input type="text" name="pmname" class="form-control" placeholder="특이사항 입력">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="fbnote" class="form-control" placeholder="특이사항 입력">
                  </div>
                </div>
                ...
                <div class="find-btn">
          			...
          			<button type="button" class="btn btn-success find-btn1">등록  </button>
