            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <!-- 세션 부여 후 ${meetingboard.writer}( ${meetingboard.writerNo} ) 추가 후 disabled 처리 -->
                    <input class="form-control" name="writer" id="disabledInput" type="text" placeholder="${meetingboard.writer}( ${meetingboard.writerNo} )" disabled>  
                  </div>
                </div>
