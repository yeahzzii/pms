      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active">
                <a href="basic_table.html">검토계획</a>
              </li>
              <li>
                <a href="${path}/fbplanlist.do">시정조치</a>
              </li>
              <li>
                <a href="advanced_table.html">기습결함</a>
              </li>
            </ul>
          </li>
          <li>
        ...
        <div class="row mb">
          ...
          <div class="content-panel">
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone">프로젝트기간</th>
                    <th class="hidden-phone">PM명</th>
                ...
                <tbody>
                  ...
                  <c:forEach var="bd" items="${rlist}">
		       			  ...
		       			  <tr ondblclick="gorDetail(${bd.rplanno})">
		       			  	<td> ${bd.rplanno} </td><td>${bd.rplanname}</td>
		       			  	<td>${bd.prjname}</td><td><fmt:formatDate value="${bd.requestdate}"/>~<fmt:formatDate value="${bd.approvaldate}"/></td>
		       				<td>${bd.pmname}</td><td>${bd.rplanstatus}</td>
		       				
		       				<td><button class="btn btn-success btn-xs" onclick="commitStatus(${bd.rplanno})"><i class="fa fa-check"></i></button>
		                      <button class="btn btn-danger btn-xs" onclick="deleteColumn(${bd.rplanno})"><i class="fa fa-trash-o " ></i></button>
				 ...
				 <form>  
     			 	<input type="hidden" id="rplanno" value=""/>
                 </form>
                </tbody>
              </table>
            ...
            <script type="text/javascript">
           		...
           		function commitStatus(rplanno){
           			if(confirm("승인 하시겠습니까?")){
           				$("#rplanno").val(rplanno)
           				alert($("#rplanno").val())
              			$("form").attr("action","${path}/updateRplanStatus.do"); 
	           			$("form").submit();
           			}
           			/*
               		var isCommit = "${isCommit}"
           			if(isCommit == "Y"){
       			 		location.href="http://localhost:7080/pms/updateRplanStatus.do"
       				}
               		*/
          ...
          <!-- page end-->
          	  <br>
          	  <p>               
                <button  type="button" class="btn btn-default button" onclick="goInsertRplan()" >검토계획 등록</button>
              </p>
        </div>
        <script type="text/javascript">
        	function goInsertRplan(){
        		location.href="${path}/rplanInsertForm.do"
        	}
