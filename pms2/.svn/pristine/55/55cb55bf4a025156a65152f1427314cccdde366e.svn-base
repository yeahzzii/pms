...
<!-- **********************************************************************************************************************************************************
            ...
            <section class="panel">
              <div class="panel-body">
                ...
                <ul class="nav nav-pills nav-stacked mail-nav">
                  ...
                  <li><a href="${path}/outboxList.do"> <i class="fa fa-file-text-o"></i> 임시보관함 <span class="label label-info pull-right inbox-notification">${mlist.size()}</span></a></li>
                ...
                <div class="compose-mail">
                  <form id="sendmail" enctype="multipart/form-data"    
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="receiver" tabindex="1" id="to" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="compose-editor">
                      <textarea class="wysihtml5 form-control" name="mailContent" rows="9"></textarea>
                      <input type="file" class="default" name="mailReport01">
                    </div>
                    <div class="compose-btn">
                      <button class="btn btn-theme btn-sm" type="submit"><i class="fa fa-check"></i> 보내기</button>
                      <button class="btn btn-sm" onclick="${path}/mailForm.do"><i class="fa fa-times"></i> 작성취소</button>
  ...
  function storageProc(){
		if(confirm("임시보관 하시겠습니까?")){
			//alert($("[name=mailReport]").val());
	   		$("#sendmail").attr("action","${path}/insertOutbox.do")
	   		$("#sendmail").submit()
	   	}
	}
