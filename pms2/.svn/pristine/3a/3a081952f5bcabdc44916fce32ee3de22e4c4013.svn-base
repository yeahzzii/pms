      ...
      <section class="wrapper site-min-height">
        ...
        <div class="chat-room mt">
          <aside class="mid-side">
            ...
            <div class="group-rom">
              <div class="first-part odd">남주혁</div>
              <div class="second-part">안녕하세요</div>
              <div class="third-part">12:30</div>
            </div>
            <div class="group-rom">
              <div class="first-part">강태오</div>
              <div class="second-part">네 안녕하세요</div>
              <div class="third-part">12:31</div>
            </div>
            <div class="group-rom">
              <div class="first-part odd">남주혁</div>
              <div class="second-part">코드 좀 봐주시겠어요?</div>
              <div class="third-part">12:32</div>
            </div>
            <div class="group-rom">
              <div class="first-part">강태오</div>
              <div class="second-part">네 보여주세요</div>
              <div class="third-part">12:32</div>
            </div>
            <div class="group-rom">
              <div class="first-part odd">남주혁</div>
              <div class="second-part">
                <a href="#">code333.PNG</a> <span class="text-muted">35.4KB</span>
                <p><img class="img-responsive" src="img/code333.PNG" alt=""></p>
              </div>
              <div class="third-part">12:32</div>
            </div>
            <div class="group-rom">
              <div class="first-part">강태오</div>
              <div class="second-part">25라인이 틀렸네요</div>
              <div class="third-part">12:32</div>
            </div>
            <div class="group-rom last-group">
              <div class="first-part odd">남주혁</div>
              <div class="second-part">감사합니다!</div>
            ...
            <footer>
              ...
              <button class="btn btn-theme">보내기</button>
            </footer>
          </aside>
          <aside class="right-side">
            ...
            <div class="invite-row">
              <h4 class="pull-left">팀원 목록</h4>
              <a href="#" class="btn btn-theme04 pull-right">+ 추가</a>
            </div>
