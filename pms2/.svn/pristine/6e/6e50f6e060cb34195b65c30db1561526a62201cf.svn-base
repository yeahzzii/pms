...
<!-- **********************************************************************************************************************************************************
	...
	<canvas id="RiskDeg" height="210"></canvas>
	<script>
    var riskdeg = []
	var riskCnt = []
	$.ajax({
	...
	<canvas id="TotScore" height="280"></canvas> 
	<script>
    var tot = []
    var prjno9 = []
	$.ajax({
                ...
                <!--  /darkblue panel -->
							...
							<div class="col-lg-8 col-sm-5 mb" style="height: 460px;"> 
								<div class="white-panel pn" style="height: 420px;">
									...
									<canvas id="PrjRate" height="130"></canvas>
	<script>
    var prjRate1 = []
    var prjno1 = []
	$.ajax({
					...
					<div class="col-lg-12 main-chart" style="margin-top:-35px; margin-bottom:60px;">
						<div class="row mt">
							...
							<div class="col-lg-6" style="height: 460px;">
								...
								<canvas id="PrjHR" height="180"></canvas>
	<script>
    var cnt = []
	var prjno2 = []
	$.ajax({
			...
			$(data).each(function(idx, p){
			 ...
			 new Chart(document.querySelector('#PrjHR'), {
                ...
                <div class="white-panel pn" style="height: 420px;">
                  ...
                  <canvas id="PrjFinance" height="180"></canvas> 
	<script>
    var prjfinance = []
	var prjno3 = []
	$.ajax({
