      ...
      <div class="top-menu">
        <form action="${path }/logout.do" method="post">
          <ul class="nav pull-right top-menu">
            <li><input type="submit" class="logout" value="Logout"></li>
          </ul>
        </form>
      </div>
    </header>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="${path}/z01_HRFileupload/jangho.jpg" class="img-circle" width="80"></a></p>
            ...
            <div class="row content-panel">
              ...
              <div class="col-md-4 centered">
                <div class="profile-pic">
                  <p><img src="${path}/z01_HRFileupload/${emp.eimage}" class="img-circle"></p>
                  ...
                  <div id="profile_update" class="tab-pane">
                    ...
                    <h3>　　　<i class="fa fa-angle-right"></i> 프로필 수정</h3>
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        ...
                        <form role="form" class="form-horizontal" action="${path}/profileUpdate.do" enctype="multipart/form-data" method="post">
                        <br><br><br>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">사원번호</label>
                            <div class="col-lg-6">
                          ...
                          <div class="form-group">
                            <label class="col-lg-2 control-label">생년월일</label>
                            <div class="col-lg-6">
                              <input type="date" id="birth" name="birthS" class="form-control"
                          ...
                          <div class="form-group">
                            <label class="col-lg-2 control-label">입사일</label>
                            <div class="col-lg-6">
                              <input type="date" id="hiredate" name="hiredateS" class="form-control"
                              	value="<fmt:formatDate value="${emp.hiredate}" pattern="yyyy-MM-dd"/>" readonly>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="file" id="eimage" name="report" class="file-pos"
                              	value="${path}/z01_HRFileupload/${emp.eimage}">
                          ...
                          <div class="form-group">
                            <label class="col-lg-2 control-label">소개글</label>
                            <div class="col-lg-10">
                              <textarea rows="10" cols="30" class="form-control" id="description" name="description">${emp.description}</textarea>
                            </div>
                          </div>
                          <center>
                       		<button class="btn btn-theme" type="button" onclick="check()">수정</button>
...
var isUpdate = "${isUpdate}"
    if(isUpdate=="Y"){
    	location.href="http://localhost:7080/pms/profile.do"
    }
