...
public class MeetingBoard {
	...
	public MeetingBoard(int recordNum, int refno, String recordTitle, String recordContent, String writer, int writerNo,
	...
	public MeetingBoard(int cnt, int recordNum, int refno, String recordTitle, String recordContent, String writer, int writerNo,
