...
<head>
  ...
  <link rel="stylesheet" href="./a01_css/empList.css">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="basic_table.html">프로젝트 A</a></li>
              ...
              <section id="unseen">
                <table class="table table-bordered table-striped table-condensed">
                  <thead>
                    <tr>
                      <th width="5%">no</th>
                      <th width="13%">사원 번호</th>
                      <th width="13%" class="numeric">사원명</th>                      
                      <th width="13%" class="numeric">직책</th>
                      <th width="13%" class="numeric">입사일</th>
                      <th width="13%" class="numeric">관리자</th>
                      <th width="13%" class="numeric">부서</th>
                  ...
                  <c:forEach var="i" begin="0" end="10">
                    <tr id="emp_tr">
                      <td >1</td>
                      <td >사원번호</td>
                      <td class="numeric">사원명<c:out value="${i}" /></td>
                      <td class="numeric">직책<c:out value="${i}" /></td>
                      <td class="numeric">입사일<c:out value="${i}" /></td>
                      <td class="numeric">관리자<c:out value="${i}" /></td>
                      <td class="numeric">부서<c:out value="${i}" /></td>
                      <td class="numeric">부서번호<c:out value="${i}" /></td>
                    </tr>    
                  </c:forEach>                
                  </tbody>
                </table>
