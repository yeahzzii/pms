          ...
          <div class="col-sm-9">
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <form role="form-horizontal" action="${path}/boardInsert.do" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" id="disabledInput" type="text" placeholder="${meetingboard.writer}( ${meetingboard.writerNo} )" disabled>
                  </div>
                </div>
                    <div class="compose-editor">
                      <textarea class="wysihtml5 form-control" rows="18">${meetingboard.recordContent}</textarea>
