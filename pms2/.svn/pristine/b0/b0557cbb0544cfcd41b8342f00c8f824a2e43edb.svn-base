      ...
      <section class="wrapper"> 
        ...
        <div class="row mb">
            ...
            <div class="adv-table">     
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <c:forEach var="bd" items="${blist}">
                  <tr ondblclick="goDetail(${bd.recordNum})">
                    <td>${bd.recordNum}</td>
                    ...
                    <td>${bd.writer}</td>
                    <td><fmt:formatDate value="${bd.recordRegdte}" type="both"/></td>
                    <td>${bd.recordViewCnt}</td> 
                  </tr>
          ...
          <div class="compose-btn">
                  ...
                  <button onclick="goInsert()" class="btn btn-theme btn-sm">등록</button>
...
<script>
function goDetail(recordNum){
	location.href="${path}/boardDetail.do?recordNum="+recordNum;
}
</script>
</body>
