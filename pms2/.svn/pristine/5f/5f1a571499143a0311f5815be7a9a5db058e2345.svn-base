              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  <c:forEach var="rm" items="${rmList}">
                  	<tr><td>${rm.rmName}</td>
                  		<td><fmt:formatDate value="${rm.rmStartDate}"/></td>
                  		<td><fmt:formatDate value="${rm.rmEndDate}"/></td>
                  		<td>${rm.rmPeriod}</td>
                  		<td>${rm.rmCost}</td>
                  </c:forEach>
                </tbody>
        ...
        <div class="col-md-12 mt">
            <div class="content-panel">
				<table class="table table-hover text-center">
					...
					<tbody>
                        <c:forEach var="prj" items="${prjcost}">
                            <tr>
                                <td>${prj.prjName}</td>
                                <td>${prj.prjFinance}</td>
                                <td>${prj.eqpmnCost}</td>
                                <td>${prj.materialCost}</td>
                                <td>${prj.serviceCost}</td>
                                <td>${prj.indirectCost}</td>
                                <td>${prj.rsrvExpns}</td>
                            </tr>
                        </c:forEach>
                    </tbody>
