...
<script type="text/javascript">
	...
	function goUpdate(prjno){
		location.href="${path}/cosPrjUpdateForm.do?prjno="+prjno;
	}
</script>
<body>
							...
							<table class="table table-hover text-center">
								...
								<thead>
									<tr>
										...
										<th class="text-center">비용 수정</th>
									</tr>
								</thead>
								<tbody>
                                    <c:forEach var="costprj" items="${costPrjList}" varStatus="status">
                                        <tr ondblclick="goDetail('${costprj.prjNo}')">
                                        	<td>${status.count}</td>
                                            <td>${costprj.prjName}</td>
                                            <td>${costprj.ename}</td>
                                            <td>${costprj.prjFinance}</td>
                                            <td>${costprj.eqpmnCost}</td>
                                            <td>${costprj.materialCost}</td>
                                            <td>${costprj.serviceCost}</td>
                                            <td>${costprj.indirectCost}</td>
                                            <td>${costprj.rsrvExpns}</td>
                                            <td><button class="btn btn-primary btn-xs" onclick="goUpdate('${costprj.prjNo}')">
