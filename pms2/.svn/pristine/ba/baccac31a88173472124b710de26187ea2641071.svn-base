      ...
      <section class="wrapper">
          ...
          <div class="content-panel">
                 ...
                 <tbody>
                  <c:forEach var="fb" items="${fblist}">
       			  ...
       			  <tr ondblclick="gofbDetail(${fb.feedbackno})"><td>${fb.feedbackno}</td><td>${fb.feedbackname}</td>
       			  	<td>${fb.fbplanname}</td><td><fmt:formatDate value="${fb.fbstartdate}"/>~<fmt:formatDate value="${fb.fbenddate}"/></td>
       				<td>${fb.pmname}</td><td>${fb.fbstatus}</td>
       				<td><button class="btn btn-success btn-xs" onclick="commitStatus()"><i class="fa fa-check"></i></button>
                      <button class="btn btn-danger btn-xs" onclick="deleteColumn()"><i class="fa fa-trash-o " ></i></button>
                    </td>
       			  </tr>
     			  </c:forEach>
                </tbody>
            ...
            <script type="text/javascript">
           		function gofbDetail(rplanno){
					location.href="${path}/fbPlanDetail.do?feedbackno="+rplanno;           			
           		} 
        ...
        <script type="text/javascript">
        	function goInsertRplan(){
        		location.href="${path}/fbplanInsertForm.do"
        	}
