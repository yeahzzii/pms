...
<head>
  ...
  <link rel="stylesheet" href="${path}/a00_Common/a01_css/projectEmpList.css">
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> 인적자원 > 인적자원 관리 > 프로젝트 참여 사원 관리</h3>
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
			  ...
			  <input name="job" value="${param.job}"  id="input01" class="form-control mr-sm-2" placeholder="프로젝트명 입력" style="width:300px;"/><br>
			  ...
			  <label class="col-lg-2 control-label">참여인원명</label>
              ...
              <section id="unseen">
                <table class="table table-bordered table-striped table-condensed">
                  <thead>
                    <tr>
                      <th width="5%">no</th>
                      <th width="13%">프로젝트 번호</th>
                      <th width="13%" class="numeric">프로젝트명</th>                      
                      <th width="13%" class="numeric">상태</th>
                      <th width="13%" class="numeric">중요도</th>
                      <th width="13%" class="numeric">참여인원수</th>
                  ...
                  <c:forEach var="i" begin="0" end="10">
                    <tr id="emp_tr">
                      <td >${i}</td>
                      <td >프로젝트 번호</td>
                      <td class="numeric">프로젝트명<c:out value="${i}" /></td>
                      <td class="numeric">상태<c:out value="${i}" /></td>
                      <td class="numeric">중요도<c:out value="${i}" /></td>
                      <td class="numeric">참여인원수<c:out value="${i}" /></td>
                      <td class="numeric">시작일<c:out value="${i}" /></td>
                      <td class="numeric">종료일<c:out value="${i}" /></td>
                    </tr>    
                  </c:forEach>                
                  </tbody>
                </table>
