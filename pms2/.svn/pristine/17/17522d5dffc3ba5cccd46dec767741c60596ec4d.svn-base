...
<script type="text/javascript">
	...
	function goScope(){
		location.href="${path}/scope.do?prjno=1";
	}
</script>
<body>
							...
							<table class="table table-hover text-center">
								...
								<thead>
									<tr>
										...
										<th class="text-center">PM번호(교체예정)</th>
										<th class="text-center">프로젝트 목표</th>
										<th class="text-center">프로젝트 중요도</th>
										<th class="text-center">검토계획/시정조치/기습결함</th>
									</tr>
								</thead>
								<tbody>
                                    <c:forEach var="qualprj" items="${prjlist}">
                                        <tr ondblclick="goDetail(${qualprj.prjNo})">
                                            <td>${qualprj.prjName}</td>
                                            <td>${qualprj.prjPMNo}</td>                                            
                                            <td>${qualprj.prjGoal}</td>
                                            <td>${qualprj.prjImportant}</td>
                                            <td>
