        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper site-min-height">
			 <h3><i class="fa fa-angle-right"></i> 소개</h3>
				<div class="row mt">
					<div class="col-lg-12">
						<div class="row content-panel">
							<div class="col-md-4 profile-text mt mb centered">
								<div class="right-divider hidden-sm hidden-xs">
									<img id="aeap_img" alt="file_img" src="img/introduce.png"/>
								</div>
							</div>
							<!-- /col-md-4 -->
							...
							<div class="col-md-4 centered">
								<div class="dropdown">
									...
									<div class="dropdown-content" id="selLan">
										<a href="#" data-value="en"><img class="country" src="img/us.png"/> </a> 
										<a href="#" data-value="zh"><img class="country" src="cn.png"/> </a>
										<a href="#" data-value="ja"><img class="country" src="jp.png"/> </a>
									</div>
								</div>
							</div>
							<!-- /col-md-4 -->
