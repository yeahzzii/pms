...
<body>
  <section id="container">
    ...
    <div class="content-panel" style="width: 96%;">
        <h4><i class="fa fa-angle-right"></i>  예산 현황</h4>
        <div class="panel-body">
          <figure class="demo-xchart" id="chart" style="height: 220px; width: 100%;"></figure>
        </div>
    </div>
    <!--  xchart end -->
              <!-- /col-md-4-->
          ...
          <div id="side-panel" class="col-lg-3 ds ">
           ...
           <div class="donut-main">
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="${path}/Dashio/img/member1.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
                  <a href="#">남주혁</a><br/>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="${path}/Dashio/img/member2.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
                  <a href="#">강태오</a><br/>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="${path}/Dashio/img/member3.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
                  <a href="#">양세종</a><br/>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="${path}/Dashio/img/member4.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
                  <a href="#">이도현</a><br/>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="${path}/Dashio/img/member5.png" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
                  <a href="#">최우식</a><br/>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="${path}/Dashio/img/bbibbi.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
                  <a href="#">삐삐</a><br/>
