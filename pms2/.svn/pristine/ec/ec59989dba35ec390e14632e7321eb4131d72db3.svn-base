            ...
            <section class="panel">
             ...
             <div class="col-md-4 ">
                  ...
                  <ul>
                    <li>
                      <a class="atch-thumb" href="#">
                        <img src="${meetingboard.mrFileName}">
                        </a>
                      <a id="mrFineName" href="#">
                        ${meetingboard.mrFileName}
                        </a>
                      <div class="links">
                        <a href="#">보기</a> -
                        <a href="#">다운로드</a>
                ...
                <div class="compose-btn">
                  ...
                  <button class="btn btn-theme btn-sm" onclick="goUpdate(${meetingbaord.recordNum})"><i class="fa fa-check"></i> 수정</button>
                 
                  <button class="btn btn-sm" onclick="deleteProc()">삭제</button>
                  <button class="btn btn-sm" onclick="replyProc()"><i class="fa fa-times"></i> 답글</button>
                  <button class="btn btn-sm"onclick="goMain()"><i class="fa fa-times"></i> 목록</button>
                </div>
              </div>
            </section>
          </div>
...
function replyProc(){
	if(confirm("답글을 처리하시겠습니까?")){
		$("[name=refno]").val($("[name=recordNum]").val())
		$("[name=recordTitle]").val("RE"+$("[name=recordTitle]").val())
		$("[name=recordContent]").val(
			"\n\n\n\n\n\n\n\n========== 상위글 ==========\n"+
			$("[name=recordContent]").val()
		);
