...
public class Emp {
	...
	// insert문을 위한 생성자
	public Emp(String empno, String id, String pw, String ename, String eimage, String birthS, String job, String mgr,
			String hiredateS, double sal, String phoneNum, String address, String deptno, String gender, String email,
			String auth, String description) {
		this.empno = empno;
		this.id = id;
		this.pw = pw;
		this.ename = ename;
	...
	public Emp(String empno, String id, String pw, String ename, String eimage, Date birth, String job, String mgr,
			Date hiredate, double sal, String phoneNum, String address, String deptno, String gender, String email,
			String auth, String description) {
		this.empno = empno;
		this.id = id;
		this.pw = pw;
